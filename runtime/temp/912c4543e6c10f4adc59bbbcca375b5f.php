<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:37:"./views/admin/pc/feedback/index.phtml";i:1595431647;s:84:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/admin/pc/common/header.phtml";i:1595431654;s:85:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/admin/pc/common/sidebar.phtml";i:1595431656;s:83:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/admin/pc/feedback/nav.phtml";i:1595431648;s:84:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/admin/pc/feedback/tabs.phtml";i:1595431651;s:84:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/admin/pc/common/footer.phtml";i:1595431653;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="content-wrapper">
    ...
    <h1>
        ...
        <small>
            <?php if($action == 'index'): ?>
            反馈列表
            <?php else: if(empty($item)): ?>添加反馈<?php else: ?>修改反馈<?php endif; endif; ?>
        </small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>反馈管理</a></li>
        <li class="active">
            <?php if($action == 'index'): ?>
            反馈列表
            <?php else: ?>
    ...
    <li <?php if(in_array($action,['index'])): ?>class="active"<?php endif; ?>>
        <a href="<?php echo U('index'); ?>" >反馈列表</a>
    </li>
    <?php if(in_array($action,['post']) && !empty($item)): ?>
        <li class="active">
            <a href="<?php echo U('post', 'id=' . $item['id']); ?>">反馈详情</a>
        </li>
    <?php endif; ?>
</ul>
                        ...
                        <div class="page-content">
                            <div class="panel panel-info">
                                <div class="panel-heading">
                                    筛选
                                    <span class="pull-right">共有反馈&nbsp;<font style="color: red;font-weight: bold;"><?php echo $total; ?></font>&nbsp;条</span>
                                </div>
                                    ...
                                    <form class="form-horizontal" method="get" role="form">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6 col-md-8 col-lg-8 col-xs-12">
                                                <input type="text" class="form-control" name="keyword" value="<?php echo !empty($_GET['keyword'])?$_GET['keyword']:''; ?>" placeholder="请输入用户名">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6 col-md-8 col-lg-8 col-xs-12">
                                                <label class="checkbox-inline">
                                                    <input type="checkbox" name="is_reply[]" <?php if(!empty($_GET['is_reply']) && in_array(0,$_GET['is_reply'])): ?>checked<?php endif; ?> value="0">
                                                    待回复
                                                </label>
                                                <label class="checkbox-inline">
                                                    <input type="checkbox" name="is_reply[]" <?php if(!empty($_GET['is_reply']) && in_array(1,$_GET['is_reply'])): ?>checked<?php endif; ?> value="1">
                                                    已回复
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <?php if(!empty($list)): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo U('post', 'id=' . $item['id']); ?>" class="btn btn-sm btn-success">回复</a>
                                                    </td>
                                                </tr>
                                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                                <tr>
