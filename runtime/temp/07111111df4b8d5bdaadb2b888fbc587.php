<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:35:"./views/admin/pc/member/index.phtml";i:1595431629;s:84:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/admin/pc/common/header.phtml";i:1595431654;s:85:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/admin/pc/common/sidebar.phtml";i:1595431656;s:81:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/admin/pc/member/nav.phtml";i:1595431630;s:82:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/admin/pc/member/tabs.phtml";i:1595431632;s:84:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/admin/pc/common/footer.phtml";i:1595431653;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <div class="page-content">
                            <div class="panel panel-info">
                                <div class="panel-heading">
                                    筛选
                                    <span class="pull-right">共有会员&nbsp;<font style="color: red;font-weight: bold;"><?php echo $total; ?></font>&nbsp;人，会员余额累计总额&nbsp;<font style="color: red;font-weight: bold;"><?php echo $credit2Total; ?></font>元</span>
                                </div>
                                    ...
                                    <form class="form-horizontal" method="get" role="form">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6 col-md-8 col-lg-8 col-xs-12">
                                                <input type="text" class="form-control" name="keyword" value="<?php echo !empty($_GET['keyword'])?$_GET['keyword']:''; ?>" placeholder="请输入会员编号、用户名、手机号关键词">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6 col-md-8 col-lg-8 col-xs-12">
                                                <label class="checkbox-inline">
                                                    <input type="checkbox" name="is_check[]" <?php if(!empty($_GET['is_check']) && in_array(1,$_GET['is_check'])): ?>checked<?php endif; ?> value="1">
                                                    正常
                                                </label>
                                                <label class="checkbox-inline">
                                                    <input type="checkbox" name="is_check[]" <?php if(!empty($_GET['is_check']) && in_array(0,$_GET['is_check'])): ?>checked<?php endif; ?> value="0">
                                                    已禁用
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="table-responsive panel-body">
                                        <table class="table table-hover">
                                            ...
                                            <?php if(!empty($list)): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                                                <tr>
                                                    <td>
                                                        <input type="checkbox" name="ids[]" value="<?php echo $item['uid']; ?>">
                                                    </td>
                                                    <td><?php echo $item['uid']; ?></td>
                                                    <td><?php echo $item['username']; ?></td>
                                                    <td>
                                                        <label class="label label-success"><?php echo $item['credit1']; ?></label>
                                                        &nbsp;/&nbsp;
                                                        <label class="label label-primary"><?php echo $item['credit2']; ?></label>
                                                    </td>
                                                    <td><?php echo $item['email']; ?></td>
                                                    <td>
                                                        账号:<?php echo $item['alipay_account']; ?> /
                                                        姓名:<?php echo $item['alipay_realname']; ?>
                                                    </td>
                                                    <td><?php echo $item['mobile']; ?></td>
                                                    <td><?php echo $item['parent_uid']; ?></td>
                                                    <td><?php echo $item['invite_total']; ?></td>
                                                    <td>
                                                        <label class="label label-success"><?php echo $item['invite_rebate']; ?></label>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo U('post', 'id=' . $item['uid']); ?>" class="btn btn-sm btn-success">编辑</a>
                                                    </td>
                                                </tr>
                                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                                <tr>
