<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:35:"./views/admin/pc/channel/post.phtml";i:1595431660;s:84:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/admin/pc/common/header.phtml";i:1595431654;s:85:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/admin/pc/common/sidebar.phtml";i:1595431656;s:82:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/admin/pc/channel/nav.phtml";i:1595431658;s:83:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/admin/pc/channel/tabs.phtml";i:1595431661;s:84:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/admin/pc/common/footer.phtml";i:1595431653;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="content-wrapper">
    ...
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> 渠道管理</a></li>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6 col-xs-12">
                                            <input type="text" class="form-control" name="title" value="<?php echo !empty($item['title'])?$item['title']:''; ?>" placeholder="请输入渠道名称">
                                        </div>
                                    </div>
                                    <div class="form-group">
