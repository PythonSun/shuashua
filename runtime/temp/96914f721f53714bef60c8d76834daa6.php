<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:36:"./views/home/mobile/task/index.phtml";i:1595431523;s:87:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/home/mobile/common/footer.phtml";i:1595431568;}*/ ?>
<!DOCTYPE HTML>
<html>
	<head>
        ...
        <div class="paging">
            ...
            <span class="paging-num-total">
					<select name="page" class="paging-selct">
                        <?php $__FOR_START_520175208__=1;$__FOR_END_520175208__=$pageCount+1;for($i=$__FOR_START_520175208__;$i < $__FOR_END_520175208__;$i+=1){ ?>
