<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:43:"./views/admin/pc/auth_admin/authgroup.phtml";i:1595431678;s:84:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/admin/pc/common/header.phtml";i:1595431654;s:85:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/admin/pc/common/sidebar.phtml";i:1595431656;s:84:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/admin/pc/common/footer.phtml";i:1595431653;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="col-xs-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active">
                            <a href="<?php echo U('authgroup', 'id=' . $item['id']); ?>">授权角色</a>
                        </li>
                    </ul>
                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7"><input class="form-control" disabled="disabled" value="【<?php echo $item['username']; ?>】<?php echo $item['nickname']; ?>" placeholder="用户名"></div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">授权角色</label>
                                        ...
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="group_id[]" value="<?php echo $vo['id']; ?>" class="minimal" <?php if(isset($vo['ischeck']) &&$vo['ischeck'] == 'y'): ?>checked="checked"<?php endif; ?> > <?php echo $vo['title']; ?>
                                        </label>
                                        </p>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                        </div>
