<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:41:"./views/admin/pc/taskcategory/index.phtml";i:1595431606;s:84:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/admin/pc/common/header.phtml";i:1595431654;s:85:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/admin/pc/common/sidebar.phtml";i:1595431656;s:96:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/admin/pc/taskcategory/nav_category.phtml";i:1595431608;s:97:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/admin/pc/taskcategory/tabs_category.phtml";i:1595431610;s:84:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/admin/pc/common/footer.phtml";i:1595431653;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                    ...
                                    <div class="table-responsive panel-body">
                                        <table class="table table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="label label-info">$<?php echo $item['min_give_credit1']; ?></span>
                                                    &nbsp;/&nbsp;
                                                    <span class="label label-warning">￥<?php echo $item['min_give_credit2']; ?></span>
                                                </td>
                                                <td>
                                                    <img style="width: 50px;height: 40px;" src="<?php echo to_media($item['thumb']); ?>">
                                                </td>
                                                ...
                                                <td>
                                                    <a role="button" href="<?php echo U('post_category', 'id=' . $item['id']); ?>" class="btn btn-sm btn-success" type="button">编辑</a>
                                                </td>
                                            </tr>
                                            <?php endforeach; endif; else: echo "" ;endif; ?>
                                            <tr>
