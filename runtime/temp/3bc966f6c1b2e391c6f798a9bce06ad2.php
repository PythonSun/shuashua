<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:36:"./views/admin/pc/member/charge.phtml";i:1595431627;s:84:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/admin/pc/common/header.phtml";i:1595431654;s:85:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/admin/pc/common/sidebar.phtml";i:1595431656;s:81:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/admin/pc/member/nav.phtml";i:1595431630;s:82:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/admin/pc/member/tabs.phtml";i:1595431632;s:84:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/admin/pc/common/footer.phtml";i:1595431653;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <div class="page-content">
                            <div class="panel panel-info">
                                <div class="panel-heading">
                                    筛选
                                    <span class="pull-right">累计充值&nbsp;<font style="color: red;font-weight: bold;"><?php echo $total; ?></font>&nbsp;次</span>
                                </div>
                                    ...
                                    <form class="form-horizontal" method="get" role="form">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6 col-md-8 col-lg-8 col-xs-12">
                                                <input type="text" class="form-control" name="keyword" value="<?php echo !empty($_GET['keyword'])?$_GET['keyword']:''; ?>" placeholder="请输入会员编号">
                                            </div>
                                        </div>
                                        <div class="form-group">
