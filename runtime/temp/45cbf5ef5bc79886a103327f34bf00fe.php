<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:37:"./views/home/mobile/index/index.phtml";i:1595431555;s:87:"/www/wwwroot/appoint.toutiaozhannei.cn/web/public/views/home/mobile/common/footer.phtml";i:1595431568;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
	<head>
        ...
        <div class="paging">
            ...
            <span class="paging-num-total">
					<select name="page" class="paging-selct">
                        <?php $__FOR_START_234948894__=1;$__FOR_END_234948894__=$pageCount+1;for($i=$__FOR_START_234948894__;$i < $__FOR_END_234948894__;$i+=1){ ?>
