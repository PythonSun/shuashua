...
define('DB_USER', 'weike');  //数据库用户名
define('DB_PWD', 'weike123456');//数据库密码
define('DB_NAME', 'weike');  //数据库名称
 ...
 *
 */
define('DB_USERTABLE', 'tb_member');  //充值用户所在数据库表名
define('DB_USERMONEY', 'credit2');  //充值用户所在表中的金额字段名
